...
fun getMockPlayers() : List<PlayerModel> = listOf(
    PlayerModel(
        ...
        age = 25,
        nick = "Ethan",
        team = Team("NRG", "https://liquipedia.net/commons/images/thumb/1/16/NRG_2024_allmode.png/100px-NRG_2024_allmode.png"),
    ...
    PlayerModel(
        ...
        age = 30,
        nick = "Boaster",
        team = Team("Fnatic", "https://liquipedia.net/commons/images/thumb/f/f9/Fnatic_2020_allmode.png/77px-Fnatic_2020_allmode.png"),
    ...
    PlayerModel(
        ...
        age = 21,
        nick = "f0rsaken",
        team = Team("Paper Rex", "https://liquipedia.net/commons/images/thumb/7/7b/Paper_Rex_darkmode.png/59px-Paper_Rex_darkmode.png"),
    ...
    PlayerModel(
        ...
        nationality = "Russia" ,
        age = 23,
        team = Team("Team Liquid", "https://liquipedia.net/commons/images/thumb/5/59/Team_Liquid_2024_darkmode.png/44px-Team_Liquid_2024_darkmode.png"),
    ...
    PlayerModel(
        ...
        age = 21,
        nick = "Kaajak",
        team = Team("Fnatic", "https://liquipedia.net/commons/images/thumb/1/16/NRG_2024_allmode.png/100px-NRG_2024_allmode.png"),
        totalWinningsDollars = 516224,
    ...
    PlayerModel(
        ...
        age = 27,
        nick = "Zellsis",
        team = Team("Sentinels", "https://liquipedia.net/commons/images/thumb/1/13/Sentinels_2020_allmode.png/50px-Sentinels_2020_allmode.png"),
        totalWinningsDollars = 421988,
    ...
    PlayerModel(
        ...
        age = 21,
        nick = "benjyfishy",
        team = Team("Team Heretics", "https://liquipedia.net/commons/images/thumb/a/a4/Team_Heretics_2022_allmode.png/40px-Team_Heretics_2022_allmode.png"),
        totalWinningsDollars = 421988,
